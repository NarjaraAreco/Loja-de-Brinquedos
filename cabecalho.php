...
<html>
    ...
    <body>
            ...
            <a href="#showcase" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white">Menu</a> 
            ...
            <a href="/Loja_Brinquedos/Controller/BrinquedoController.php?acao=listarBrinquedos" class="w3-bar-item w3-button">Gerenciar Brinquedos</a> 
